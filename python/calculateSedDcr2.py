...
if __name__ == "__main__":
    pickleFile = "calculateSedDcr2M.pickle"
    ...
    sp1.set_xticklabels(xlabs, minor=False, weight="bold", fontsize=12)
    ...
    sp2.set_xticklabels(xlabs, minor=False, weight="bold", fontsize=12)
    sp2.set_yticklabels(airmass1+dairmasses[::2], minor=False, weight="bold", fontsize=12)
    cb2 = plt.colorbar(hmap2, ax=sp2, fraction=0.05, pad=0.025)
    ...
    sp3.set_xticklabels(xlabs, minor=False, weight="bold", fontsize=12)
    ...
    sp4.set_xticklabels(xlabs, minor=False, weight="bold", fontsize=12)
    sp4.set_yticklabels(airmass1+dairmasses[::2], minor=False, weight="bold", fontsize=12)
    cb4 = plt.colorbar(hmap4, ax=sp4, fraction=0.05, pad=0.025)
